...
assessment_2018 <- collapse %>%
    ...
    mutate(grade = if_else(grade == 0, "Missing Grade", as.character(grade)),
        pct_approaching = if_else(valid_tests != 0, round(100 * n_approaching/valid_tests+1e-9, 1), NA_real_),
        ...
        pct_below = if_else(valid_tests != 0, round(100 - pct_approaching - pct_on_track - pct_mastered+1e-9, 1), NA_real_),
